...
class Calculator {
    ...
    public static void main(String[] args) throws Error {
        ...
        if (Arrays.asList(charAllowedArab).contains(strNum[0]) && Arrays.asList(charAllowedArab).contains(strNum[1])){
            ...
            throw new Error("формат математической операции не удовлетворяет заданию - два операнда,\n числа от 1 до 10(только римские или только арабские) и один оператор (+, -, /, *)");
        }
    }
}